      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            className="px-10 py-4 rounded-xl bg-white text-blue-700 font-bold text-base md:text-lg transition-[transform,box-shadow] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] shadow-lg shadow-black/15 hover:-translate-y-1 hover:scale-[1.03] hover:bg-slate-50 hover:shadow-2xl active:translate-y-0 active:scale-100"
          >
